...
<nav class="navbar navbar-expand-lg navbar-light ">
  <div class="container">
    <a class="navbar-brand" href="index.php?p=select_main">KonsulDong</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ml-auto js-signin-modal-trigger">
        ...
        <a class="nav-item nav-link" href="pages/about.php">About</a>
        <?php
...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <div class="row">
      <div class="col-sm-8 ">
        <h1 class="display-4">Banyak Psikiater <b>spesialis</b><br /> akan <b>membantu</b> anda</h1>
          </div>
      </div>
  </div>
  </div>
